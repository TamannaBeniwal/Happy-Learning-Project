...
function DrawingActivity() {
  ...
  const teachers = [
    { id: 1, name: "Mrs. Neetu Sharma", experience: "3 years", style: "Creative Art & Imagination" },
    { id: 2, name: "Mr. Jatin Choudhary", experience: "3 years", style: "Colorful Story Drawing" },
    { id: 3, name: "Mrs. Avni Singhal", experience: "2 years", style: "Fun Painting & Shapes" },
  ];
  ...
  return (
    <div className="drawing-container">
      <h2 className="drawing-title">Drawing & Coloring Adventure </h2>
      <p className="drawing-subtitle">Choose your teacher and explore fun drawing activities</p>

      
      <div className="teacher-section">
        <h3 className="section-title">Choose Your Drawing Teacher:</h3>
      ...
      {selectedTeacher && (
        <div className="selected-box">
          ...
          <p className="start-text">
             Let’s start drawing with <strong>{selectedTeacher.name.split(" ")[1]}</strong>!
          </p>
        </div>
      )}
